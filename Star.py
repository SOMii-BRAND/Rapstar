...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;42m[1]  START CLONING With SOMI'
    time.sleep(0.10)
...
def action():
    ...
    if peak =='':
        ...
        os.system("clear")
        print logo1
        print "\033[;92mEnter any  Mobile code Number"+'\n'
        print '\033[;92mEnter any code ,175,165,191, 192, 193, 194, 195, 196, 197, 198, 199'
        print '\033[;92Only bangla phone number'
        try:
